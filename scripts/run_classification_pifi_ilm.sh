...
# Legacy-style classification PiFi with ILM auto-selection (root-path layout)
...
for DS in ${DATASETS}; do
  ...
  SEL_JSON="$ROOT_DIR/results/layer_selection/classification/${DS}/${MODEL}/${LLM}/selection.json"
  if [ -f "$SEL_JSON" ]; then
...
echo "[ILM] Completed classification PiFi ILM experiments."
