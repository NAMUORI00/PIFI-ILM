...
# Full layer sweep for IMDB sentiment classification with PiFi
# Default: layers 0..23, 3 epochs each. Runtime shorter than MNLI but still long.
...
echo "[DONE] IMDB full layer sweep completed."
